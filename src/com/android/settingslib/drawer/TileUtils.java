...
public class TileUtils {
    ...
    public static void getTilesForIntent(Context context, UserHandle user, Intent intent,
        ...
        for (ResolveInfo resolved : results) {
            ...
            //将不符合的界面:metaData为null或者其中的没有指定的catetory(EXTRA_CATEGORY_KEY),或者categoryKey为null去除掉
            if (checkCategory && ((metaData == null) || !metaData.containsKey(EXTRA_CATEGORY_KEY))
                ...
                //EXTRA_CATEGORY_KEY = "com.android.settings.category";
            ...
            if (tile == null) {
                ...
                //将Tile中其他信息补全,也就是所谓的updateTileData
                updateTileData(context, tile, activityInfo, activityInfo.applicationInfo, pm);
                if (DEBUG) Log.d(LOG_TAG, "Adding tile " + tile.title);
                //key是activity的包名和类名.tile包含了他的category(归类,不仅仅只是上边书写的那几个,看配置的文件了),
